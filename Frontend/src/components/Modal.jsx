                            ...
                            <div className="max-w-lg mx-auto mt-8">
                                <form onSubmit={handleUpdateNote}>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <textarea id="edescription" name="edescription" value={note.edescription} onChange={handleInputChange} rows="4" className="mt-1 p-2 border border-gray-300 rounded-md w-full"></textarea>
                                    </div>
                                    <div className="mb-4">
